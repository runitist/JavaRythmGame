...
public class DynamicBeat extends JFrame {
	...
	private Image titleImage = new ImageIcon(
			this.getClass().getResource("../img/Ed Sheeran - Shape Of You ( cover by J.Fla ) title.png")).getImage();
	...
	private Image selectedImage = new ImageIcon(
			this.getClass().getResource("../img/Ed Sheeran - Shape Of You ( cover by J.Fla ) 600x450.jpg")).getImage();
